...
export function Hero() {
  ...
  return (
  	<div className="flex lg:flex-row lg:pt-0 justify-center align-middle h-[48rem] w-full  bg-custom_gradient flex-col-reverse items-center pt-10" > 
        ...
        <button className="bg-text border-solid border-outline border-[0.1rem] text-text_secondary mt-10 w-1/2 h-16 font-kanit-thin font-bold hover:scale-105 transition duration-150 ease-in-out hover:shadow-2xl hover:outline hover:outline-8 hover:outline-green hover:outline-offset-2">Start Now!</button>
      </div>
