import { personPNG  } from "../../assets.jsx"; 
export function Hero() {
  ...
  return (
  	<div className="flex lg:flex-row lg:pt-0 justify-center align-middle h-[46rem] w-full  bg-custom_gradient flex-col-reverse items-center pt-10" > 
        ...
        <h1 className="xl:text-8xl sm:text-6xl lg:mt-[10rem] italic font-archivo-black-regular text-center text-5xl max-w-[48rem]">Make your way to your <span className="animate-colorAnimation">dream </span>job!</h1>
