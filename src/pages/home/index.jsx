  ...
  return (
    <main className="flex flex-col items-center">
      <Hero
        ...
        image={Images.person}
        button={{
          label: language == "en" ? "Start Now!" : "Comece Agora",
      ...
      <Panels
        icon="signs"
        title={language === "en" ? "Go Beyond" : "Vá Além"}
        places={[
          {
            image: Images.houses,
            description:
      ...
      <Slider
        ...
        slides={[
          ...
          },
          {
            ...
            title:
              language === "en" ? "Cleaning Services" : "Serviços de Limpeza",
            description:
              language === "en"
          ...
          },
          {
            ...
            title:
              language === "en" ? "Agricultural Work" : "Trabalho Agrícola",
            description:
              language === "en"
      ...
      <TextGrid
        ...
        elements={[
          {
            icon: "suitcase",
            title: language === "en" ? "Job Prospecting" : "Busca de Empregos",
            description:
              language === "en"
                ? "Using our best techniques of job prospecting, we can help you find the best opportunities in the market."
                : "Usando nossas melhores técnicas, podemos ajudar você a encontrar as melhores oportunidades no mercado.",
          },
          {
            icon: "calendar",
            title:
              language === "en" ? "Time Organization" : "Organização de Tempo",
            description:
              language === "en"
          ...
          },
          {
            icon: "man",
            title:
              language === "en" ? "Account Management" : "Gestão de Contas",
            description:
              language === "en"
                ? "By letting us manage your various job network accounts, you will maximize your chances of getting your job."
                : "Ao nos permitir gerir suas diversas contas de rede de trabalho, você maximizará suas chances.",
          },
          {
            icon: "support",
      ...
      <VisualGrid
        icon="paperpeople"
        title={language === "en" ? "Lives Transformed" : "Vidas Transformadas"}
        elements={[
          {
            image: Images.man1,
            title: "Alex Martins",
          ...
          },
          {
            ...
            title: "Carlos Mota",
            subtitle:
              language === "en" ? "Truck Driver" : "Motorista de Caminhão",
            description:
              language === "en"
          ...
          },
          {
            image: Images.man3,
            title: "Marcos Totti",
            subtitle: language === "en" ? "Chef" : "Chef de Cozinha",
            description:
              language === "en"
